...
INSERT INTO Hoods VALUES (1, "Downtown Brooklyn", "(40.6902, -73.9943)", "(40.7059, -73.9809)");
INSERT INTO Hoods VALUES (2, "Midtown Manhattan", "(40.7477, -73.9929)", "(40.7647, -73.9739)");
INSERT INTO Hoods VALUES (3, "Uptown Bronx", "(40.8113, -73.9315)", "(40.8830, -73.7945)");


-- Live in different blocks
INSERT INTO Blocks VALUES (1, "Jay Street", 1, "(40.6962, -73.9872)", "(40.6998, -73.9868)");
INSERT INTO Blocks VALUES (2, "Gold Street", 1, "(40.6922, -73.9834)", "(40.7056, -73.9823)");
INSERT INTO Blocks VALUES (3, "5th Avenue From 34th Street to 59th Street", 2, "(40.7485, -73.9846)", "(40.7644, -73.9730)");
INSERT INTO Blocks VALUES (4, "6th Avenue From 34th Street to 59th Street", 2, "(40.7498, -73.9878)", "(40.7657, -73.9761)");
...
INSERT INTO BlockApplication VALUES (12, "2019-01-01 12:00:02", 4, "I am your new neighbor", 0, 0);


-- Two people already in the same block group
INSERT INTO Friends VALUES (1, 2, "2019-01-01 12:00:03");
INSERT INTO Friends VALUES (4, 5, "2019-01-01 12:00:03");

-- Two people in the same hood, but not the same block
INSERT INTO Friends VALUES (7, 8, "2019-01-01 12:00:03");
INSERT INTO Friends VALUES (7, 10, "2019-01-01 12:00:03");

-- One move to a new place, but still keeps old friendship, and make new friends in new group
INSERT INTO Friends VALUES (2, 11, "2019-02-01 12:00:03");
...
INSERT INTO Neighbors VALUES (1, 2, "2019-01-01 12:00:03");
INSERT INTO Neighbors VALUES (1, 3, "2019-01-01 12:00:03");

INSERT INTO Neighbors VALUES (2, 1, "2019-01-01 12:00:03");
INSERT INTO Neighbors VALUES (2, 3, "2019-01-01 12:00:03");

INSERT INTO Neighbors VALUES (3, 1, "2019-01-01 12:00:03");
INSERT INTO Neighbors VALUES (3, 2, "2019-01-01 12:00:03");
INSERT INTO Neighbors VALUES (3, 4, "2019-01-01 12:00:03");
INSERT INTO Neighbors VALUES (3, 5, "2019-01-01 12:00:03");

INSERT INTO Neighbors VALUES (5, 4, "2019-01-01 12:00:03");

INSERT INTO Neighbors VALUES (7, 8, "2019-01-01 12:00:03");
INSERT INTO Neighbors VALUES (7, 9, "2019-01-01 12:00:03");
INSERT INTO Neighbors VALUES (7, 10, "2019-01-01 12:00:03");
INSERT INTO Neighbors VALUES (7, 11, "2019-01-01 12:00:03");

INSERT INTO Neighbors VALUES (8, 9, "2019-01-01 12:00:03");
INSERT INTO Neighbors VALUES (8, 10, "2019-01-01 12:00:03");
INSERT INTO Neighbors VALUES (8, 11, "2019-01-01 12:00:03");

INSERT INTO Neighbors VALUES (9, 7, "2019-01-01 12:00:03");
INSERT INTO Neighbors VALUES (9, 8, "2019-01-01 12:00:03");
INSERT INTO Neighbors VALUES (9, 10, "2019-01-01 12:00:03");
INSERT INTO Neighbors VALUES (9, 11, "2019-01-01 12:00:03");

INSERT INTO Neighbors VALUES (10, 11, "2019-01-01 12:00:03");

INSERT INTO Neighbors VALUES (11, 8, "2019-01-01 12:00:03");
INSERT INTO Neighbors VALUES (11, 9, "2019-01-01 12:00:03");
INSERT INTO Neighbors VALUES (11, 10, "2019-01-01 12:00:03");


-- Someone sends message to friends
INSERT INTO Message VALUES (1, 1, 1, "2019-01-01 12:00:04", "LOL", "Life", "I am happy", "(40.6962, -73.9872)");

-- Someone sends message to neighbors, and coordinates is null
INSERT INTO Message VALUES (2, 5, 2, "2019-01-01 12:00:04", "???", "Life", "Stop using my Wi-Fi", "");

-- Someone sends message to block
INSERT INTO Message VALUES (3, 8, 3, "2019-01-01 12:00:04", "Help", "Work", "Can someone help me with my school work?", "(40.7498, -73.9878)");

-- Someone sends message to hood, and coordinates is null
INSERT INTO Message VALUES (4, 7, 4, "2019-01-01 12:00:04", "Vote time", "Food", "Which one do you prefer, medium rare or medium steak?", "");

-- Someone sends message to particular person from friends
INSERT INTO Message VALUES (5, 7, 0, "2019-01-01 12:00:04", "Hello", "Life", "How's your weekend?", "(40.7657, -73.9761)");
...
INSERT INTO Message VALUES (7, 2, 0, "2019-01-01 12:00:04", "Invitation", "Life", "Have dinner with me?", "(40.7056, -73.9823)");

-- Specifically for bicycle accident
---- Keyword in title, in neighbor feed
INSERT INTO Message VALUES (8, 9, 2, "2019-01-01 12:00:04", "Bicycle Accident", "Emergency", "Somebody is hit by a bicycle in the block", "(40.7498, -73.9878)");
---- Keyword in subject, in block feed
INSERT INTO Message VALUES (9, 10, 3, "2019-01-01 12:00:04", "Terrible!", "Bicycle Accident", "I was hit by a bicycle...", "(40.7498, -73.9878)");
---- Keyword in text, in hood feed
INSERT INTO Message VALUES (10, 11, 4, "2019-01-01 12:00:04", "Accident Report", "Accident", "There is a bicycle accident in the block!", "(40.7498, -73.9878)");


-- Recipient data based on test data in Message
INSERT INTO Recipient VALUES (5, 8);
INSERT INTO Recipient VALUES (6, 10);
INSERT INTO Recipient VALUES (7, 3);


-- General data
INSERT INTO MailBox VALUES (2, 1, false);
INSERT INTO MailBox VALUES (4, 2, true);
INSERT INTO MailBox VALUES (9, 3, false);
INSERT INTO MailBox VALUES (10, 3, true);
INSERT INTO MailBox VALUES (11, 3, true);
INSERT INTO MailBox VALUES (3, 7, true);
INSERT INTO MailBox VALUES (8, 5, false);


-- They need to reply, so they must have read the message
INSERT INTO MailBox VALUES (8, 4, true);
INSERT INTO MailBox VALUES (9, 4, true);
INSERT INTO MailBox VALUES (10, 4, true);
INSERT INTO MailBox VALUES (11, 4, true);
INSERT INTO MailBox VALUES (10, 6, true);

-- After reply, message's author will get updated in his/her mailbox
INSERT INTO MailBox VALUES (7, 4, false);
INSERT INTO MailBox VALUES (9, 6, false);

-- Specifically for bicycle accident
INSERT INTO MailBox VALUES (7, 8, false);
INSERT INTO MailBox VALUES (8, 8, false);
INSERT INTO MailBox VALUES (10, 8, false);
INSERT INTO MailBox VALUES (11, 8, false);

INSERT INTO MailBox VALUES (8, 9, false);
INSERT INTO MailBox VALUES (9, 9, false);
INSERT INTO MailBox VALUES (11, 9, false);

INSERT INTO MailBox VALUES (7, 10, false);
INSERT INTO MailBox VALUES (8, 10, false);
INSERT INTO MailBox VALUES (9, 10, false);
INSERT INTO MailBox VALUES (10, 10, false);
...
INSERT INTO Reply VALUES (4, 8, "2019-01-01 12:00:06", "Medium Rare", "");
